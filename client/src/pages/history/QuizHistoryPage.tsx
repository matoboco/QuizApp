...
function GameHistoryCard({ game }: { game: GameHistorySummary }) {
  ...
  return (
    <Link
      ...
      className="block bg-cyber-card border border-primary-500/15 rounded-lg shadow hover:shadow-neon-cyan transition-shadow p-6"
    >
      <div className="flex justify-between items-start mb-4">
        <div>
          <p className="text-sm text-gray-400">PIN: {game.pin}</p>
    ...
    <div className="min-h-screen bg-cyber-dark">
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            <Link to="/dashboard" className="text-sm text-gray-400 hover:text-gray-200 mb-2 inline-block">
        ...
        {games.length === 0 ? (
          <div className="bg-cyber-card border border-primary-500/15 rounded-lg shadow p-8 text-center">
            <p className="text-gray-400 mb-4">No games have been played yet for this quiz.</p>
